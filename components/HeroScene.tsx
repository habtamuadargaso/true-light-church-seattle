...
function GlowingCross() {
  ...
  return (
    <>
      ...
      <pointLight ref={lightRef} position={[2, 3, 4]} color="#ffe9c2" intensity={2.2} distance={24} />
      <pointLight position={[-3, -2, 3]} color="#88a6d9" intensity={0.6} distance={24} />

      <mesh ref={glowRef}>
        <sphereGeometry args={[2.4, 32, 32]} />
        <meshBasicMaterial color="#f0d9a3" transparent opacity={0.12} />
      </mesh>
      ...
      <points ref={particlesRef}>
        ...
        <pointsMaterial color="#f5efe0" size={0.028} transparent opacity={0.55} />
      </points>
    </>
  );
}
