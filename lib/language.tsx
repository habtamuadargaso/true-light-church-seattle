...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    "about.leadership": "Built on a legacy of faithful service, our church continues to proclaim Christ, make disciples, and shine His light in our community.",
    ...
    "sermons.description": "Listen to sermons from Pastor Dereje Gadafa and grow in faith.",
  ...
  am: {
    ...
    "about.leadership": "በታማኝ አገልግሎት ውርስ ላይ የተገነባችው ቤተ ክርስቲያናችን ክርስቶስን መስበክን፣ ደቀ መዛሙርትን ማፍራትን እና ብርሃኑን በማኅበረሰባችን ውስጥ ማብራትን ቀጥላለች።",
    ...
    "sermons.description": "ከPastor Dereje Gadafa ስብከቶችን ያዳምጡ እና በእምነት ያድጉ።",
